      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="text-xl font-bold gradient-text mb-3">PixelPerfect AI</div>
            <p className="text-foreground/70 max-w-md">
              Transform your photos with cutting-edge AI technology. 
              Our advanced algorithms enhance images to professional quality in seconds.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-foreground/60">
            &copy; {new Date().getFullYear()} PixelPerfect AI. All rights reserved @Sriharsha.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" aria-label="Twitter" className="text-foreground/60 hover:text-foreground transition-colors">
